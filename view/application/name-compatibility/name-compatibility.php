...
echo '
                ...
                <div id="column2">
                    ...
                    <div id="num_content">
                        ...
                        <form id="name-compatibility-form" action = "javascript:void(0);" method="POST">
                            <div id="name-compatibility">
                                <div>
                                    <div class="clear"></div>
                                </div>';
                                    echo '<input id="name1" name="user1" placeholder="Numele tau" type="text"/>';
                                    echo '<input id="name2" name="user2" placeholder="Numele iubitului sau iubitei" type="text"/>';
                            ...
                            <button id="calculate-name-compatibility">Calculeaza</button>
