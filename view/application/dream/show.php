            ...
            <div id="columns">
                ...
                <div id="column2">
                    <div id="article">
                        ...
                        <div class="sonnik_header">Ce ai visat ?</div>
                        <div class="sonnik_search">
                            <form id="search-dream-form"  action = "javascript:void(0);">
                                <input id="word-search" class="sonnik_input" name="dream_name" placeholder="Introduceti cuvintu cheie din vis" value="" type="text">
